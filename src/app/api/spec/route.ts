...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    paths: {
      ...
      "/api/files": { get: { summary: "List shared files — PLANNED NOT LIVE (501 file_share_planned)", tags: ["Files"] }, post: { summary: "Upload file — PLANNED NOT LIVE (501)", tags: ["Files"] } },
      "/api/files/share": { post: { summary: "Share file with peer — PLANNED NOT LIVE (501 file_share_planned)", tags: ["Files"] } },
      "/api/files/{id}": { get: { summary: "Get shared file — PLANNED NOT LIVE (501)", tags: ["Files"] }, delete: { summary: "Delete shared file — PLANNED NOT LIVE (501)", tags: ["Files"] } },
